  ...
  return (
    <div className="p-8 max-w-2xl">
      ...
      <div className="bg-[#13131f] border border-[#1e1e2e] rounded-xl p-6 mb-4">
        ...
        <a href="https://github.com/devdigitalcordex-ctrl/agency-hub/releases" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 bg-[#1e1e2e] hover:bg-[#252535] text-slate-300 text-sm px-4 py-2.5 rounded-lg transition w-full">
          <Github size={14} />
      ...
      <div className="bg-[#13131f] border border-[#1e1e2e] rounded-xl p-6">
        ...
        <ol className="space-y-3">
          {['Download the ZIP file above','WordPress Admin → Plugins → Add New → Upload Plugin','Upload ZIP → Install Now → Activate','Settings → Agency Hub','Hub URL: https://agency-hub-gamma.vercel.app','Paste Connection Key from site page in Hub','Save Settings → Test Connection Now','Site shows Online in Hub within seconds'].map((step, i) => (
